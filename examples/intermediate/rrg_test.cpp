...
int main(int argc, char* argv[])
{
  ...
  PRX_DEBUG_PRINT
  context.first->get_state_space()->copy_point_from_vector(rrg_query.start_state,
                                                           params["/plant/start_state"].as<std::vector<double>>());
  context.first->get_state_space()->copy_point_from_vector(rrg_query.goal_state,
  ...
  vis_group->add_vis_infos(info_geometry_t::LINE, rrg_query.tree_visualization, body_name, ss);
