...
int main(int argc, char* argv[])
{
    ...
    rrt_star_spec.steer = [&](space_point_t& state, space_point_t& local_goal, plan_t& plan, trajectory_t& traj)
    {
    // bool omnirobot_FO_t::
    ...
    rrt_star_query_t rrt_star_query(context.first -> get_state_space(), context.first -> get_control_space());
    ...
    context.first -> get_state_space() -> copy_point_from_vector(rrt_star_query.start_state, params["/plant/start_state"].as<std::vector<double>>());
    context.first -> get_state_space() -> copy_point_from_vector(rrt_star_query.goal_state, params["/plant/goal_state"].as<std::vector<double>>());

    rrt_star_query.goal_region_radius = params["goal_region_radius"].as<double>();
