...
#include "prx/utilities/learned_modules/dense_roadmap.hpp"
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        std::string points_fname = output_path + "indoors_superdense_5/" + "points.txt";
        ...
        std::string vertex_fname = output_path + "indoors_superdense_5/"  + "vertices.txt";
        std::string edge_fname = output_path + "indoors_superdense_5/"  + "edges.txt";
        std::string time_fname = output_path + "indoors_superdense_5/"  + "time.txt";
        ...
        {
            auto edge = *e;
            std::string traj_fname = output_path + "indoors_superdense_5/traj/" + "traj_" + std::to_string(edge.first) + "_" + std::to_string(edge.second) + ".txt";
            std::ofstream fout;
