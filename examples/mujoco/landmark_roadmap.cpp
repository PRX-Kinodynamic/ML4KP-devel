...
int main(int argc, char* argv[])
{
    try
    {
        ...
        std::string points_fname = output_path + "mushr_landmark_roadmap/" + "points.txt";
        ...
        std::string vertex_fname = output_path + "mushr_landmark_roadmap/" + "vertices.txt";
        std::string edge_fname = output_path + "mushr_landmark_roadmap/" + "edges.txt";
        std::string time_fname = output_path + "mushr_landmark_roadmap/" + "time.txt";
        ...
        {
            auto edge = *e;
            std::string traj_fname = output_path + "mushr_landmark_roadmap/" + "traj_" + std::to_string(edge.first) + "_" + std::to_string(edge.second) + ".txt";
            std::ofstream fout;
