...
public:
  ...
  void add_detailed_vis_infos(info_geometry_t info_type, const trajectory_t& traj, std::string body_name,
                              const space_t* state_space, std::string color = "0xFF0000");
   ...
   */
  void add_animation(const trajectory_t& traj, const space_t* state_space, space_point_t default_state = nullptr);
