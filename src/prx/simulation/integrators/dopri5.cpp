...
void dopri5_t::step()
{
  ...
  {
    yn->at(i) =
        start_integration_state->at(i) + h * (b1 * k1->at(i) + b2 * k2->at(i) + b3 * k3->at(i) + b4 * k4->at(i) +
  ...
  {
    k_cache->at(i) =
        h * ((b1 - bh1) * k1->at(i) + (b2 - bh2) * k2->at(i) + (b3 - bh3) * k3->at(i) + (b4 - bh4) * k4->at(i) +
