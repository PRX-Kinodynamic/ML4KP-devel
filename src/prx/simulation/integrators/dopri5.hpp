...
public:
  ...
  dopri5_t(space_t* state_space, space_t* derivative_space, std::function<void()> deriv_f,
           const double initial_simulation_step = 0.01, const double _atol = 1e-12, const double _rtol = 1e-6,
           const int _nsteps = 500, const double _max_step = 0.0, const double _safety = 0.9,
           const double _ifactor = 5.0, const double _dfactor = 0.2, const double _beta = 0.0);

  dopri5_t(space_t* state_space, space_t* derivative_space, std::function<void()> deriv_f,
           const double initial_simulation_step, const std::vector<double> atol, const std::vector<double> rtol,
           const int _nsteps = 500, const double _max_step = 0.0, const double _safety = 0.9,
           const double _ifactor = 10.0, const double _dfactor = 0.2, const double _beta = 0.0);
