...
namespace prx
{
	...
	class noisy_plant_t : public plant_t
    {
		...
		noisy_plant_t(const system_ptr_t& _sys_ptr, Types... args)
			: plant_t(_sys_ptr)
		{
		...
		virtual bool linearize(Eigen::MatrixXd& A, Eigen::MatrixXd& B, Eigen::MatrixXd& C, Eigen::MatrixXd& D, space_point_t xt = nullptr, space_point_t ut = nullptr, double epsilon = 1e-3) override
		{
