 ...
 * prx::factory_registration::VAR_##SYSTEM_NAME##_REGISTRED is true.
 */
...
#define PRX_REGISTER_CUSTOM_SYSTEM(SYSTEM_CLASS, SYSTEM_NAME, ...)                                                     \
  ...
  namespace factory_registration                                                                                       \
  {                                                                                                                    \
  static std::shared_ptr<SYSTEM_CLASS> FN_##SYSTEM_NAME##_GENERATOR = [](std::string path, __VA_ARGS__) {              \
 ...
 * @return             If the registration is successful, the variable
 * prx::factory_registration::VAR_##SYSTEM_NAME##_VEL_FN_REGISTRED is true.
 */
#define PRX_REGISTER_VELOCITY_FN(SYSTEM_NAME, VEL_FN)                                                                  \
  ...
  namespace factory_registration                                                                                       \
  {                                                                                                                    \
  const bool VAR_##SYSTEM_NAME##_VEL_FN_REGISTRED =                                                                    \
      system_factory_t::get().register_velocity_fn(#SYSTEM_NAME, VEL_FN);                                              \
  }                                                                                                                    \
  }
