...
/**
 * state_limit_factor is a class which enforces limits to states
 */
class state_limit_factor : public gtsam::NoiseModelFactor1<double> 
{
    private:
    using This = state_limit_factor;
     ...
     */
    state_limit_factor(gtsam::Key q_key,
