...
public:
  ...
  heuristic_map_t(const double world_origin[2], const double _goalx, const double _goaly, const int grid_h,
                  const int grid_w, const double c_size, const int _k, const bool use_min_cost1);

  // corl constructor
  heuristic_map_t(const double world_origin_x, const double world_origin_y, const double _goalx, const double _goaly,
                  const int grid_h, const int grid_w, const double c_size, const std::string map_fname,
                  const int padding);
  ...
  void process_map(double** new_map, double origin[2], int grid_h, int grid_w, const double _goalx, const double _goaly,
                   double c_size);
