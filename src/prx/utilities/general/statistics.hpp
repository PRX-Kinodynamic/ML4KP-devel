...
public:
  ...
  /**
   * f test to determine if the null hypothesis (variance of the samples is equal) and that any variation is down to
   * chance. Can also test the alternative hypothesis that any difference is not down to chance.
