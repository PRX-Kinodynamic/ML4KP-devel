...
class zipped_t
{
  ...
  struct zipped_iterator
  {
    ...
    inline typename std::enable_if<I == sizeof...(Tp), void>::type tuple_increment(std::tuple<Tp...>& t, int n)
    {
    }
    ...
    template <std::size_t I = 0, typename... Tp>
    inline typename std::enable_if<I == sizeof...(Tp), bool>::type tuple_equal(const std::tuple<Tp...>& a,
                                                                               const std::tuple<Tp...>& b) const
    {
      return true;
    }
    ...
    template <std::size_t I = 0, typename... Tp>
        ...
        I<sizeof...(Tp), bool>::type tuple_equal(const std::tuple<Tp...>& a, const std::tuple<Tp...>& b) const
    {
...
public:
  ...
  template <std::size_t I = 0, typename... Tp>
      ...
      I<sizeof...(Tp), void>::type tuple_begin_create(std::tuple<typename Tp::iterator...>& tb, std::tuple<Tp*...>& t)
  {
