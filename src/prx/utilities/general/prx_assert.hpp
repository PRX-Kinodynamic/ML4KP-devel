...
public:
  ...
  prx_assert_t(const std::string& message) : message(message)
  {
    std::ostringstream out_stream;
...
#define prx_throw_quiet(MESSAGE)                                                                                       \
  {                                                                                                                    \
    throw prx::prx_assert_t((prx::prx_assert_t::stream_t() << MESSAGE));                                               \
  }
 ...
 */
#define prx_throw_backtrace(...)                                                                                       \
  {                                                                                                                    \
    throw prx::prx_assert_t().get_backtrace(__VA_ARGS__);                                                              \
  }
