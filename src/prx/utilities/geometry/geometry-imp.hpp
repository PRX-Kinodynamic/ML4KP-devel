...
std::shared_ptr<PQPModelType> new_pqp_model(std::vector<std::vector<double>>& vertices, std::vector<face_t>& faces)
{
  std::shared_ptr<PQPModelType> model = std::make_shared<PQPModelType>();

  model->BeginModel();
  typename PQPModelType::TranslationType first, second, third;
...
template <typename PQPModelType>
std::shared_ptr<PQPModelType> create_box_trimesh(double lx, double ly, double lz)
{
  ...
  return new_pqp_model<PQPModelType>(vertices, faces);
}

template <typename PQPModelType>
std::shared_ptr<PQPModelType> create_sphere_trimesh(double radius)
{
  std::vector<std::vector<double>> vertices;
  std::vector<face_t> faces;
  std::vector<double> v = { 0, 0, 0 };
...
template <typename PQPModelType>
std::shared_ptr<PQPModelType> create_ellipsoid_trimesh(double a, double b, double c)
{
  std::vector<std::vector<double>> vertices;
  std::vector<face_t> faces;
  std::vector<double> v = { 0, 0, 0 };
...
template <typename PQPModelType>
std::shared_ptr<PQPModelType> create_cone_trimesh(double radius, double height)
{
...
template <typename PQPModelType>
std::shared_ptr<PQPModelType> create_cylinder_trimesh(double radius, double height)
{
  double angle;
  std::vector<std::vector<double>> vertices;
  std::vector<face_t> faces;
...
inline std::pair<std::vector<std::vector<double>>, std::vector<face_t>> create_capsule_info(double radius,
                                                                                            double height)
{
  double angle, height_angle;
  int i, j;
...
template <typename PQPModelType>
std::shared_ptr<PQPModelType> create_capsule_trimesh(double radius, double height)
{
  auto info_vals = create_capsule_info(radius, height);
  return new_pqp_model<PQPModelType>(info_vals.first, info_vals.second);
}
