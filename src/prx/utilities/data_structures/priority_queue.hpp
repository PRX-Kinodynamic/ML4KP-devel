 ...
 */
template <class Node>
typedef std::function<bool(const std::shared_ptr<Node>&, const std::shared_ptr<Node>&)> compare_function_t;
template <class Node>
typedef std::function<bool(const std::shared_ptr<Node>&, const std::shared_ptr<Node>&)> equivalent_function_t;

template <class T = std::shared_ptr<Node>, class Container = std::list<T>, class Compare = compare_function_t,
...
public:
  ...
  {
    container.clear();
    cmp_function = [](const std::shared_ptr<Node>& n1, const std::shared_ptr<Node>& n2) {
      return n1->cost_to_come < n2->cost_to_come;
    };
    eq_function = [](const std::shared_ptr<Node>& n1, const std::shared_ptr<Node>& n2) {
