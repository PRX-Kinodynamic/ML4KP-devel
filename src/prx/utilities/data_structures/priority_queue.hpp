...
typedef std::function<bool(const std::shared_ptr<rrt_node_t>&, const std::shared_ptr<rrt_node_t>&)>
    equivalent_function_t;

template <class T = std::shared_ptr<rrt_node_t>, class Container = std::list<T>, class Compare = compare_function_t,
