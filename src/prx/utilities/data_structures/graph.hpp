...
public:
  ...
  graph_edge_t(node_index_t _endpoint_1, node_index_t _endpoint_2) : abstract_edge_t()
  {
...
public:
  ...
  std::vector<std::reference_wrapper<Edge>> out_edges(size_t node_index)
  {
    ...
    std::transform(std::begin(out_edge_indices), std::end(out_edge_indices), std::back_inserter(out_edge_vector),
  ...
  std::vector<std::reference_wrapper<Edge>> in_edges(size_t node_index)
  {
    ...
    std::transform(std::begin(in_edge_indices), std::end(in_edge_indices), std::back_inserter(in_edge_vector),
                   [this](auto edge_index) { return this->get_edge(edge_index); });
  ...
  std::vector<std::reference_wrapper<Node>> parents(size_t node_index)
  {
    ...
    std::transform(std::begin(in_edge_vec), std::end(in_edge_vec), std::back_inserter(parent_nodes),
  ...
  std::vector<std::reference_wrapper<Node>> children(size_t node_index)
  {
    ...
    std::transform(std::begin(out_edge_vec), std::end(out_edge_vec), std::back_inserter(child_nodes),
