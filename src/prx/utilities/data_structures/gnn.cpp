...
namespace prx
{
// double default_gnn_distance_function_t::operator()(const proximity_node_t* s1, const proximity_node_t* s2)
// {
//   return prx::space_t::euclidean_distance(static_cast<abstract_node_t*>(s1)->point,
//                                           static_cast<abstract_node_t*>(s2)->point);
// }
...
// std::vector<proximity_node_t*> graph_nearest_neighbors_t::radius_and_closest_query(const space_point_t& point,
//                                                                                    double rad)
// {
//   query_node->point = point;
...
// int graph_nearest_neighbors_t::find_k_close(proximity_node_t* state, proximity_node_t** close_nodes, double*
// distances,
//                                             int k)
// {
//   if (nr_nodes == 0)
...
// int graph_nearest_neighbors_t::find_delta_close_and_closest(proximity_node_t* state, proximity_node_t** close_nodes,
//                                                             double* distances, double delta)
// {
//   if (nr_nodes == 0)
//   {
//     return 0;
...
// int graph_nearest_neighbors_t::find_delta_close(proximity_node_t* state, proximity_node_t** close_nodes,
//                                                 double* distances, double delta)
// {
//   if (nr_nodes == 0)
//   {
...
// void graph_nearest_neighbors_t::sort_proximity_nodes(proximity_node_t** close_nodes, double* distances, int low,
//                                                      int high)
// {
//   if (low < high)
//   {
...
// proximity_node_t* graph_nearest_neighbors_t::basic_closest_search(proximity_node_t* state, double* the_distance,
//                                                                   long unsigned* the_index)
// {
//   if (nr_nodes == 0)
//   {
//     return nullptr;
