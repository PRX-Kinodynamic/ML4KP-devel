...
namespace prx
{
  ...
  rrt_star_t::rrt_star_t(const std::string& new_name) : planner_t(new_name)
  {
    ...
    _state_space = nullptr; // Initialize _state_space to nullptr
  }


  space_t* rrt_star_t::get_state_space() 
  {
    return _state_space;
  }
  ...
  bool rrt_star_t::_link_and_setup_query(planner_query_t* query)
  {
    ...
    if (_tree.num_vertices() == 0 || !_state_space->equal_points(_tree.get_vertex_as<rrt_star_node_t>(_start_vertex)->point, _rrt_star_query->start_state))
    {
  ...
  void rrt_star_t::from_files(const std::string file_prefix, const std::string directory)
  {
    ...
    //const std::string filename_tree{ directory };
    //std::string filename_tree = "/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/pih_0001_tree_rectangular_16mm_updated_2.txt";
    //const std::string filename_trajs{ "/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/pih_0001_trajectories_rectangular_16mm_updated_2.txt" };
    
    const std::string filename_trajs{ directory + "/" + file_prefix + "_trajectories.txt" };
    const std::string filename_tree{ directory + "/" + file_prefix + "_tree.txt" };
    //const std::string filename_trajs{ directory + "/" + file_prefix };
    //const std::string filename_tree{ directory + "/" + file_prefix };
    ...
    // Check if trajectory file can be opened
    std::ifstream testFile(filename_trajs);
    if (!testFile.good()) 
    {
        std::cerr << "Failed to open trajectory file: " << filename_trajs << std::endl;
        return;
    }
    testFile.close();

    // Check if tree file can be opened
    testFile.open(filename_tree);
    if (!testFile.good()) 
    {
        std::cerr << "Failed to open tree file: " << filename_tree << std::endl;
        return;
    }
  ...
  void rrt_star_t::to_files(const std::string file_prefix, const std::string directory)
  {
    ...
    //std::string filename_tree = "/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/pih_0001_tree_rectangular_16mm_updated_3.txt";
    //const std::string filename_trajs{ "/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/pih_0001_trajectories_rectangular_16mm_updated_3.txt" };
    ...
    // filename_tree is the same as the directory
    //const std::string filename_tree{ directory };
