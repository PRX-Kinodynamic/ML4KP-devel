...
// 	param_loader planner_functions_loader =
// param_loader(pl["planner_functions"]);

// 	if(planner_type=="rrt")
// 	{
// 		wrapper->planner = new rrt_t(planner_name);
// 		wrapper->planner_functions =
// create_planner_functions(planner_context,context,planner_functions_loader);
// 		auto spec = new rrt_specification_t(sg,cg);

// 		spec->cost_function = wrapper->planner_functions->cost_function;
// 		spec->distance_function =
// wrapper->planner_functions->distance_function; 		spec->sample_state =
// wrapper->planner_functions->sample_state; 		spec->sample_plan =
// wrapper->planner_functions->sample_plan; 		spec->valid_state =
// wrapper->planner_functions->valid_state; 		spec->valid_check =
// wrapper->planner_functions->valid_check; 		spec->propagate =
// wrapper->planner_functions->propagate;

// 		wrapper->planner_spec = spec;
// 		wrapper->planner_query = new
// rrt_query_t(state_space,control_space); 		return wrapper;
// 	}
...
// 		wrapper->planner_spec = spec;
// 		wrapper->planner_query = new
// sst_query_t(state_space,control_space); 		return wrapper;
// 	}
...
// wrapper->planner_functions->valid_state; 		spec->valid_check =
// wrapper->planner_functions->valid_check; 		spec->propagate =
// wrapper->planner_functions->propagate; 		spec->h =
// wrapper->planner_functions->h; 		spec->expand =
// wrapper->planner_functions->expand;

// 		wrapper->planner_spec = spec;
// 		wrapper->planner_query = new
// dirt_query_t(state_space,control_space); 		return wrapper;
// 	}
...
// 		wrapper->planner_spec = spec;
// 		wrapper->planner_query = new
// rastar_query_t(state_space,control_space); 		return wrapper;
// 	}
// 	else
// 	{
