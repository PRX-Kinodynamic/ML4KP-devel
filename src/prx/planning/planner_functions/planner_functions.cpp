...
void default_propagate(space_point_t& start_state, plan_t& plan, trajectory_t& out_traj,
...
{
  prx_assert(rad > 0, "default_goal_check: radius has to be grater than zero!") int end = full_dim ? p->size() : 2;
