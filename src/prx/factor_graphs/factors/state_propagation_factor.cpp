...
Eigen::VectorXd state_propagation_factor_t::compute_error(Eigen::VectorXd xt0, Eigen::VectorXd xt1,
                                                          Eigen::VectorXd ut1) const
{
...
Eigen::VectorXd state_propagation_factor_t::evaluateError(const X1& xt0, const X2& xt1, const X3& ut1,
                                                          ...
                                                          boost::optional<Eigen::MatrixXd&> H3) const
{
  ...
  if (H1)
  {
    std::function<Eigen::VectorXd(Eigen::VectorXd)> fp =
        std::bind(&state_propagation_factor_t::compute_error, this, std::placeholders::_1, xt1, ut1);
  ...
  {
    std::function<Eigen::VectorXd(Eigen::VectorXd)> fp =
        std::bind(&state_propagation_factor_t::compute_error, this, xt0, std::placeholders::_1, ut1);
  ...
  {
    std::function<Eigen::VectorXd(Eigen::VectorXd)> fp =
        std::bind(&state_propagation_factor_t::compute_error, this, xt0, xt1, std::placeholders::_1);
