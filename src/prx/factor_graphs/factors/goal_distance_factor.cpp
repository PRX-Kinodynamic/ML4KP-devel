...
Eigen::VectorXd goal_distance_factor_t::compute_error(Eigen::VectorXd xt_v) const
{
...
Eigen::VectorXd goal_distance_factor_t::evaluateError(const X& xt_v, boost::optional<Eigen::MatrixXd&> H1) const
{
  if (H1)
  {
    std::function<Eigen::VectorXd(Eigen::VectorXd)> fp =
        std::bind(&goal_distance_factor_t::compute_error, this, std::placeholders::_1);
