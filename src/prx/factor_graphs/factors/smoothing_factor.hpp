 ...
 */
class smoothing_factor_t : public gtsam::NoiseModelFactor2<Eigen::VectorXd, Eigen::VectorXd>
{
private:
  using This = smoothing_factor_t;
...
public:
   ...
   */
  smoothing_factor_t(gtsam::Key key_1, gtsam::Key key_2, const gtsam::noiseModel::Base::shared_ptr& cost_model,
                     double _epsilon = 0.001)
    : Base(cost_model, key_1, key_2)
  {
    epsilon = _epsilon;
  }
