/* ----------------------------------------------------------------------------
 * factor_graphs Copyright 2020, Georgia Tech Research Corporation,
...
public:
  min_time_factor_t(gtsam::Key _time_key, const gtsam::noiseModel::Base::shared_ptr& cost_model)
...
public:
  Eigen::VectorXd evaluateError(const double& t_step, boost::optional<gtsam::Matrix&> H = boost::none) const override
  {
