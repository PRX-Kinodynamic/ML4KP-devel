...
mushrFG_t::mushrFG_t(const std::string& path)
  : plant_t(path), _params_ubar_u(0.01, 0.0, 1.0), _ubar(mushrTypes::Ubar::type::Zero())
// : plant_t(path), _length(0.2965), _params_ubar_u(0.01, 0.0, 1.0, 0.3), _ubar(mushrTypes::Control::Zero())
{
  ...
  state_space->set_bounds({ -100, -100, -prx::constants::pi, -10, -10 }, { 100, 100, prx::constants::pi, 10, 10 });
