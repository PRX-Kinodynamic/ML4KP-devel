...
//    >
class bullet_simulator_t : public simulator_t, public b3RobotSimulatorClientAPI
...
public:
  ...
  static void get_euler_from_quaternion(btVector3& rpy2, const btQuaternion& quat);

  static void get_quaternion_from_euler(btQuaternion& quat, const btVector3& rollPitchYaw);
