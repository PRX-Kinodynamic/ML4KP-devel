...
void (prx::three_js_group_t::*update_vis_infos_1_0)(prx::info_geometry_t, const prx::trajectory_t&, std::string,
                                                    prx::space_t*,
                                                    std::string color) = &prx::three_js_group_t::add_vis_infos;
void (prx::three_js_group_t::*update_vis_infos_2_0)(prx::info_geometry_t, std::vector<prx::vector_t>, std::string,
                                                    double) = &prx::three_js_group_t::add_vis_infos;
// void (prx::three_js_group_t::*update_vis_infos_2_2)(prx::info_geometry_t, std::vector<prx::vector_t>, std::string) =
// &prx::three_js_group_t::add_vis_infos; void (prx::three_js_group_t::*update_vis_infos_2_3)(prx::info_geometry_t,
// std::vector<prx::vector_t>)                                               = &prx::three_js_group_t::add_vis_infos;
void (prx::three_js_group_t::*add_detailed_vis_infos_0)(prx::info_geometry_t, const prx::trajectory_t&, std::string,
                                                        prx::space_t*,
                                                        std::string) = &prx::three_js_group_t::add_detailed_vis_infos;

struct three_js_group_wrap : prx::three_js_group_t, wrapper<prx::three_js_group_t>
{
  three_js_group_wrap(const std::vector<prx::system_ptr_t>& in_plants) : three_js_group_t(in_plants){};
  three_js_group_wrap(const std::vector<prx::system_ptr_t>& in_plants,
                      const std::vector<std::shared_ptr<prx::movable_object_t>>& in_obstacles)
    : three_js_group_t(in_plants, in_obstacles){};

  void update_vis_infos_0_1(prx::info_geometry_t info_type, std::vector<prx::trajectory_t>& tree_vis,
                            std::string body_name, prx::space_t* state_space)
  {
    add_vis_infos(info_type, tree_vis, body_name, state_space);
  }
  void update_vis_infos_1_1(prx::info_geometry_t info_type, const prx::trajectory_t& traj, std::string body_name,
  ...
  void add_detailed_vis_infos_1(prx::info_geometry_t info_type, const prx::trajectory_t& traj, std::string body_name,
                                prx::space_t* state_space)
  {
