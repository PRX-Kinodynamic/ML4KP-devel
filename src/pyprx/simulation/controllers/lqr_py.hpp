...
void pyprx_simulation_controllers_lqr()
{
    ...
    // class_<prx::lqr_t, bases<controller_wrap>>("lqr", no_init)
		.def("__init__", make_constructor(&init_as_ptr<prx::lqr_t, prx::system_ptr_t, std::string >, default_call_policies()))
		.def("__init__", make_constructor(&init_as_ptr<prx::lqr_t, prx::system_ptr_t, Eigen::MatrixXd, Eigen::MatrixXd, std::string >, default_call_policies()))
