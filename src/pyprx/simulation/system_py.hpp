...
struct system_wrap : prx::system_t, wrapper<prx::system_t>
{
  ...
  prx::space_t* get_system_wrap_state_space()
  {
    return prx::system_t::state_space;
  }
  void set_system_wrap_state_space(prx::space_t* val)
  {
    prx::system_t::state_space = val;
  }

  prx::space_t* get_system_wrap_input_control_space()
  {
    return prx::system_t::input_control_space;
  }
  void set_system_wrap_input_control_space(prx::space_t* val)
  {
    prx::system_t::input_control_space = val;
  }

  prx::space_t* get_system_wrap_parameter_space()
  {
    return prx::system_t::parameter_space;
  }
  void set_system_wrap_parameter_space(prx::space_t* val)
  {
    prx::system_t::parameter_space = val;
  }
};
