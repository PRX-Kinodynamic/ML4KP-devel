...
{
    class_<prx::noisy_plant_t<T>, std::shared_ptr<prx::noisy_plant_t<T>>, bases<prx::plant_t>,boost::noncopyable>(name.c_str(), no_init )
		.def("__init__", make_constructor(&init_as_ptr<prx::noisy_plant_t<T>, prx::system_ptr_t, Types... >, default_call_policies()))
