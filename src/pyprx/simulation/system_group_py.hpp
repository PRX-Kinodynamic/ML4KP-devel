...
void  (prx::system_group_t::*propagate_4p0)(prx::space_point_t, prx::controller_ptr_t, prx::condition_check_t&, prx::space_point_t) = &prx::system_group_t::propagate;
void  (prx::system_group_t::*propagate_4p1)(prx::space_point_t, prx::controller_ptr_t, prx::condition_check_t&, prx::trajectory_t&) = &prx::system_group_t::propagate;
