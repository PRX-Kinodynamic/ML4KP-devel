...
void  (prx::system_group_t::*propagate_4)(prx::space_point_t, prx::controller_ptr_t, prx::condition_check_t&, prx::space_point_t) = &prx::system_group_t::propagate;
