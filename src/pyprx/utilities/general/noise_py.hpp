...
void bind_noise(const std::string& name)
{
  ...
  // void (T::*add_noise_space_point_wrapper)(const prx::space_point_t& pt, unsigned int start, unsigned int end) =
  // &T::add_noise; void (T::*add_noise_space_point_wrapper_2)(const prx::space_point_t& pt, unsigned int start) =
  // &T::add_noise;
