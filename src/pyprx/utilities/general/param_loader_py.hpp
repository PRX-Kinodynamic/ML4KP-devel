...
void bindings()
{
  class_<prx::param_loader>("param_loader", init<>())
      ...
      .def("as_unsigned", &prx::param_loader::as<std::size_t>)
      .def("__str__", &prx::param_loader::as<std::string>)
      .def("__int__", &prx::param_loader::as<int>)
      .def("__float__", &prx::param_loader::as<double>)
      .def("__bool__", &prx::param_loader::as<bool>)
