...
void set_precision(const int precision_in)
{
  prx::constants::precision = precision_in;
}
int get_precision()
{
  return prx::constants::precision;
}

void set_separating_value(const char separating_value_in)
{
  prx::constants::separating_value = separating_value_in;
}
char get_separating_value()
{
  return prx::constants::separating_value;
}
...
void bindings()
{
  ...
  scope constants_scope = class_<ConstantsScope>("constants")  //
                              .def("set_precision", &set_precision)
                              .def("get_precision", &get_precision)
                              .def("set_separating_value", &set_separating_value)
                              .def("get_separating_value", &get_separating_value);
  constants_scope.attr("pi") = prx::constants::pi;
  constants_scope.attr("epsilon") = prx::constants::epsilon;
  constants_scope.attr("infinity") = prx::constants::infinity;
  constants_scope.attr("precision") = prx::constants::precision;
  constants_scope.attr("separating_value") = prx::constants::separating_value;
