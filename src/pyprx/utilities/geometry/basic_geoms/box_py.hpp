...
// prx::box_t* create_box(std::string object_name, double dim_x, double dim_y, double dim_z, const prx::transform_t
// pose)
std::shared_ptr<prx::box_t> create_box(std::string object_name, double dim_x, double dim_y, double dim_z,
