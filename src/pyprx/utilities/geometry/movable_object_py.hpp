...
std::vector<std::pair<std::string,std::shared_ptr<prx::transform_t>>> get_configurations_shared(prx::movable_object_t obj)
{
...
void pyprx_utilities_geometry_movable_object_py()
{
    ...
    PRX_ITERABLE_WRAPPER_NONSTR(SINGLE_ARG(std::vector<std::pair<std::string,std::shared_ptr<prx::geometry_t>>>), "vector_of_movable_object_geometry")
    // PRX_ITERABLE_WRAPPER(std::vector<std::pair<std::string,std::weak_ptr<prx::transform_t>>>, "vector_of_movable_object_transform")
    PRX_ITERABLE_WRAPPER_NONSTR(SINGLE_ARG(std::vector<std::pair<std::string,std::shared_ptr<prx::transform_t>>>), "vector_of_movable_object_transform")
