...
void bindings()
{
  ...
  class_<prx::graph_nearest_neighbors_t, std::shared_ptr<prx::graph_nearest_neighbors_t>>("graph_nearest_neighbors",
                                                                                          no_init)
      .def("__init__", make_constructor(&init_as_ptr<prx::graph_nearest_neighbors_t, prx::distance_function_t>,
                                        default_call_policies(), (arg("distance_function"))))
      ...
      // .def("", &prx::graph_nearest_neighbors_t::)
      // .add_property("added_index", &get_proximity_node_t_added_index<long unsigned>,
      // &set_proximity_node_t_added_index<long unsigned>) .def("", &prx::proximity_node_t::)
      ;
}
