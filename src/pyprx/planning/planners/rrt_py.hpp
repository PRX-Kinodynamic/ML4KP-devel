...
void bindings()
{
  ...
  class_<prx::rrt_specification_t, std::shared_ptr<prx::rrt_specification_t>, bases<prx::planner_specification_t>>(
      ...
      .def("__init__", make_constructor(&init_as_ptr<prx::rrt_specification_t, std::shared_ptr<prx::system_group_t>,
                                        ...
                                        default_call_policies(), (arg("sg"), arg("cg"))))
      .add_property("cost_function", &get_rrt_specification_t_cost_function<prx::cost_function_t>,
                    &set_rrt_specification_t_cost_function<prx::cost_function_t>)
      .add_property("distance_function", &get_rrt_specification_t_distance_function<prx::distance_function_t>,
                    &set_rrt_specification_t_distance_function<prx::distance_function_t>)
      .add_property("sample_state", &get_rrt_specification_t_sample_state<prx::sample_state_t>,
                    &set_rrt_specification_t_sample_state<prx::sample_state_t>)
      .add_property("sample_plan", &get_rrt_specification_t_sample_plan<prx::sample_plan_t>,
                    &set_rrt_specification_t_sample_plan<prx::sample_plan_t>)
      .add_property("valid_check", &get_rrt_specification_t_valid_check<prx::valid_trajectory_t>,
                    &set_rrt_specification_t_valid_check<prx::valid_trajectory_t>)
      .add_property("valid_stop_check", &get_rrt_specification_t_valid_stop_check<prx::valid_stop_t>,
                    &set_rrt_specification_t_valid_stop_check<prx::valid_stop_t>)
      .add_property("valid_state", &get_rrt_specification_t_valid_state<prx::valid_state_t>,
                    &set_rrt_specification_t_valid_state<prx::valid_state_t>)
      .add_property("propagate", &get_rrt_specification_t_propagate<prx::propagate_t>,
                    &set_rrt_specification_t_propagate<prx::propagate_t>)
      ...
      .add_property("use_replanning", &get_rrt_specification_t_use_replanning<bool>,
                    &set_rrt_specification_t_use_replanning<bool>)
      .add_property("min_control_steps", &get_rrt_specification_t_min_control_steps<int>,
  ...
  class_<prx::rrt_t, std::shared_ptr<prx::rrt_t>, bases<prx::planner_t>>("rrt", no_init)
      .def("__init__",
           make_constructor(&init_as_ptr<prx::rrt_t, std::string>, default_call_policies(), (arg("new_name"))))
