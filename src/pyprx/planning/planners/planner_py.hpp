...
void bindings()
{
  class_<prx::planner_query_t, std::shared_ptr<prx::planner_query_t>>("planner_query", no_init)
      ...
      .add_property("goal_state", &get_planner_query_t_goal_state<prx::space_point_t>,
                    &set_planner_query_t_goal_state<prx::space_point_t>)
      .add_property("goal_check", &get_planner_query_t_goal_check<prx::goal_check_t>,
                    &set_planner_query_t_goal_check<prx::goal_check_t>)
      .add_property("get_visualization", &get_planner_query_t_get_visualization<bool>,
                    &set_planner_query_t_get_visualization<bool>)
      .add_property("solution_traj", &get_planner_query_t_solution_traj<prx::trajectory_t>,
                    &set_planner_query_t_solution_traj<prx::trajectory_t>)
      .add_property("solution_plan", &get_planner_query_t_solution_plan<prx::plan_t>,
                    &set_planner_query_t_solution_plan<prx::plan_t>)
