...
{
  const gtsam::Key s0_0{ prx::fg::symbol_factory_t::create_hashed_symbol("test", 0) };
  const gtsam::Key s0_1{ prx::fg::symbol_factory_t::create_hashed_symbol("test", 0) };

  std::string expected_0_0{ "test0" };
  std::string expected_0_1{ "test0" };

  std::string result_0_0{ prx::fg::symbol_factory_t::formatter(s0_0) };
  std::string result_0_1{ prx::fg::symbol_factory_t::formatter(s0_1) };
