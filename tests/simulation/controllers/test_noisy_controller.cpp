...
BOOST_AUTO_TEST_CASE(noisy_pendulum_test)
{
  prx::system_ptr_t plant_1 = prx::system_factory_t::create_system("pendulum", "pendulum-noisy");
...
{
  prx::system_ptr_t plant_2 = prx::system_factory_t::create_system("Acrobot", "acrobot-noisy");
