...
BOOST_AUTO_TEST_CASE(integrators)
{
  ...
  std::vector<std::vector<double> > ctrls = {
    { 6.94678, 0.12, 0.12 },  { 6.70279, 0.28, 0.4 },  { 6.22159, 0.33, 0.73 },  { -3.61730, 0.36, 1.09 },
    { -5.02736, 0.23, 1.32 }, { -1.41110, 0.2, 1.52 }, { -6.98014, 0.43, 1.95 }, { -6.73070, 0.2, 2.15 },
    { -3.74701, 0.1, 2.25 },  { 2.47204, 0.29, 2.54 }, { 3.82880, 0.37, 2.91 },  { -4.03203, 0.01, 2.92 },
    { -2.47204, 0.43, 3.35 }
  };
