#define BOOST_TEST_MODULE system_factory_test
...
{
  std::vector<std::string> system_names = { "2D_Point",     "rally_car",          "treaded_vehicle", "3D_Point",
                                            "Acrobot",      "fixed_wing",         "omni_mantis",     "koules",
                                            "racecar_mini", "FO_treaded_vehicle", "Ackermann_FO" };

  std::vector<std::pair<std::string, std::string>> fn_names = { { "2D_Point", "2D_Point" },
                                                                { "rally_car", "rally_car" },
