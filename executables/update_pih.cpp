...
int main(int argc, char* argv[])
{
  ...
  const std::string out_dir_updated{ prx::out_path + "peg_in_hole/pih_0001_tree_updated.txt" };
  const std::string out_dir_updated_traj{ prx::out_path + "peg_in_hole/pih_0001_trajectories_updated.txt" };
  ...
  std::ofstream updatedFile(prx::lib_path + "/pih_rectangular_16mm_0001_tree_2_updated.txt");
  ...
  //auto suggestedStates = readSuggestedStates(prx::"/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/replan_states_rectangular_16mm_2_transformed.txt", ss);
  //auto suggestedStates = readSuggestedStates("/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/replan_states_rectangular_16mm_2_transformed.txt", ss);
  
  //auto suggestedStates = readSuggestedStates(prx::lib_path + "/suggested_states.txt", ss);
  
  // Read the suggested states from the file /common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/replan_states_rectangular_16mm_2_transformed.txt
  auto suggestedStates = readSuggestedStates("/common/home/im316/RL4Insertion_code/ML4KP-devel/out/peg_in_hole/replan_states_rectangular_16mm_2_transformed.txt", ss);
  //PRX_DEBUG_PRINT;

  Transform transform_b_to_c{ Transform::Identity() }; // bottom to center
  Transform transform_w_to_c{ Transform::Identity() }; // world to center
  transform_b_to_c.translation() = Eigen::Vector3d(0.0, 0.0, params["/plant/length"].as<double>() / 2.0); 
  ...
  vis_group->output_html("rectangular_16mm_updated_rrt_star_visualization.html");
