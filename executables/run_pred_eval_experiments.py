...
for pt in tqdm(planning_times):
    for h in horizons:
        if pt < h:
            ...
            planner_params["output_dir"] = "dynamic/pred_test"
            ...
            cmd = [os.environ["DIRTMP_PATH"]+"bin/examples/dynamic_obstacles/predictive_model_test","examples/test.yaml"]
            popen = subprocess.Popen(cmd)
            time.sleep(1)

subprocess.call ("rm -rf "+os.environ["DIRTMP_PATH"]+"resources/input_files/examples/test.yaml", shell=True)
print("Done!")