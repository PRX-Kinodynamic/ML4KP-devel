...
with open('/home/dhruv/2024/projects/ml4kp_ktamp/resources/models/push/model_easy.xml', 'r') as file:
    mjx_content = file.read()
FOLDER = '/home/dhruv/2024/projects/NAMO/out/trees/*.txt'
...
points = []
for i in tqdm(list(glob(FOLDER))):
    with open(i, 'r') as f:
        for line in f:
