...
with open('/home/dhruv/2024/projects/ml4kp_ktamp/resources/models/push/model_full_open.xml', 'r') as file:
    mjx_content = file.read()
FOLDER = f'/home/dhruv/2024/projects/NAMO/out/fullopen/test/trees/*'
