...
roadmap_dir = os.environ["DIRTMP_PATH"] + "out/1026/"

for fname in os.listdir(roadmap_dir):
    if fname.endswith(".txt"):
        if mode == "trajectories" and fname.startswith("traj"):
            ...
            mid = int(len(traj)/2)
            plt.arrow(traj[mid,0],traj[mid,1],traj[mid+1,0]-traj[mid,0],traj[mid+1,1]-traj[mid,1],color='black',width=0.2)
