...
int main(int argc, char** argv)
{
  ...
  // auto ip = CreateRobotFromFile(kUrdfPath + std::string("inverted_pendulum.urdf"));
  ...
  // auto graph = graph_builder.trajectoryFG(ip, t_steps, dt, CollocationScheme::Trapezoidal);
  ...
  // {
  //   std::vector<gtsam::Key> keys = { JointAngleKey(j1_id, t), JointVelKey(j1_id, t), JointAccelKey(j1_id, t),
  //                                    TorqueKey(j1_id, t) };
