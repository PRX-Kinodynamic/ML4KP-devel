...
config = {
    ...
    "save_dir": "executables/v3/diffusion_v2/saved_models/only_object_mask/apr30/fixed_start_fixed_goal_many_env_with_cond_inp_5_example",
    "mode": "test", # train, test, zmq
    "load_model_path": "executables/v3/diffusion_v2/saved_models/only_object_mask/apr30/fixed_start_fixed_goal_many_env_with_cond_inp_5_example/epoch_4000",
...
class Runner:
    ...
    def load_model(self, model_folder):
        ...
        # self.dinoProjector.load_state_dict(torch.load(f"{model_folder}/dino_projector.pth"))
...
if __name__ == "__main__":
    ...
    if config["mode"] == "train":
        ...
        folder_name = os.path.join("executables/v3/diffusion_v2/arp30/diffusion_5example", config['env_config_name'])
        ...
        while True:
            ...
            if False:
                ...
                for i in range(num_samples):
                    ...
                    print(predicted_obj_center, goal_center)
